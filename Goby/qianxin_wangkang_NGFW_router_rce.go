...
func init() {
	expJson := `{
  "Name": "奇安信网康 下一代防火墙 router 远程命令执行漏洞",
  "Description": "",
  "Product": "",
  "Homepage": "",
  "DisclosureDate": null,
  "Author": "清晨",
  "FofaQuery": "app=\"网康科技-下一代防火墙\" || product=\"网康科技-下一代防火墙\"",
  "GobyQuery": "app=\"网康科技-下一代防火墙\" || product=\"网康科技-下一代防火墙\"",
  "Level": "3",
  "Impact": "",
  "Recommendation": "",
  "References": [],
  ...
  "Translation": {
    ...
    "EN": {
      "Name": "qianxin wangkang NGFW router rce",
      "Product": "",
      "Description": "",
      "Recommendation": "",
      "Impact": "",
