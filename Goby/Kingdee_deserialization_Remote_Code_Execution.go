...
func init() {
  ...
  "PostTime": "2023-06-20",
  "Author": "清晨",
  "FofaQuery": "product=\"金蝶云星空-管理中心\" || \"Services/Dispose.ashx\"",
  "GobyQuery": "product=\"金蝶云星空-管理中心\" || \"Services/Dispose.ashx\"",
  "Level": "3",
  "Impact": "",
  "Recommendation": "",
  "References": [],
        ...
        "checks": [
          {
            ...
            "variable": "$body",
            "operation": "contains",
            "value": "序列化类型为Kingdee.BOS.Core.Metadata.BusinessInfo",
            "bz": ""
          }
        ]
      },
  ...
  "Translation": {
    ...
    "EN": {
      "Name": "Kingdee deserialization Remote Code Execution",
      "Product": "",
      "Description": "",
      "Recommendation": "",
      "Impact": "",
